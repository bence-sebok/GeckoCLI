/*
 * Modified by:        NASZALY Gabor <naszaly@mit.bme.hu>
 * Date (yyyy-mm-dd):  2017-08-30 
 *
 * Modification to the original file: addition of function declarations
 * for BSP_ButtonGet(), BSP_ButtonsGet() and BSP_ButtonsInit().
 *
*/
