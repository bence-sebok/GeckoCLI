/*
 * Modified by:        KOVACSHAZY Tamas <khazy@mit.bme.hu>
 *                     NASZALY Gabor <naszaly@mit.bme.hu>
 * Date (yyyy-mm-dd):  2017-08-30 
 *
 * Modification to the original file: 
 *   - the condition to define the default retarget device has been appended by
 *     " && !(RETARGET_VCOM)".
 *   - VCOM has been set as default.
*/
...
#if !defined(RETARGET_USART1) && !defined(RETARGET_LEUART0) && !(RETARGET_UART0) && !(RETARGET_VCOM)
#define RETARGET_VCOM    /* Use VCOM by default. */
#endif
